...
@media(max-width:850px){.workbench-head{flex-direction:column;align-items:flex-start}.preview-heading{align-items:flex-start;flex-direction:column}.preview-slots{grid-template-columns:repeat(2,minmax(0,1fr))}.preview-slot:nth-child(2){border-right:0}.preview-slot:nth-child(n+3){border-top:1px solid var(--line-soft)}.preview-slot:last-child{grid-column:1/-1}.editor-layout,.analysis-grid{grid-template-columns:1fr}.identity,.acquisition-card{grid-column:auto}.toolbar{align-items:stretch;flex-direction:column}.toolbar label{align-items:flex-start;flex-direction:column}.toolbar-actions{flex-wrap:wrap}.editor-footer{align-items:flex-start;flex-direction:column}.issue-list code{flex-basis:8rem}.metric-list{grid-template-columns:1fr 1fr}.acquisition-card ol{grid-template-columns:1fr 1fr}}
</style>
