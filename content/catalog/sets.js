...
export const armorSets = [
  set('truth-of-rights', '权利真相', 'Truth of Rights', '叛逃者', '多部位激活递增套装加成，侧重持续作战', ['生命值', '手雷'], 'set-truth-of-rights'),
  set('aion-adapter', 'AION 适配者', 'AION Adapter Suit', '宿命边缘', '适配开普勒环境的战术护甲', ['生命值', '职业'], 'set-aion-adapter'),
  set('aion-renewal', 'AION 复兴', 'AION Renewal Suit', '宿命边缘', '技能循环与元素协同套装', ['手雷', '超能'], 'set-aion-renewal'),
  ...
  set('praxic', '普拉希克', 'Praxic Vestment', '叛逃者', '生命值与超能倾向套装', ['生命值', '超能'], 'set-praxic'),
